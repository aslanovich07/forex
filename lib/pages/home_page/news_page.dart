...
import 'package:forex/pages/detail_pages/news_detail_page.dart';
import 'package:forex/pages/detail_pages/news_detail_page2.dart';
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const NewsDetailPage2(),
                      ),
                    );
                  },
                  child: const NewsContainer(
